...
window.ec_hello = function ()
 {if (navigator.userAgent.toLowerCase().indexOf('chrome') > -1)
   {var args = [
     '\n %c %c %c ec.core' +'' + '  %c ' + ' %c ' + ' https://github.com/selfsame/place-makers/tree/master/src/ec  %c %c :)\n\n',
    ...
    {console.log('ec.core https://github.com/selfsame/place-makers/tree/master/src/ec'); }};
